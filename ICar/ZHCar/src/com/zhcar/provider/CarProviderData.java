...
public interface CarProviderData {
	...
	String KEY_CARINFO_AKEY = "AKey";
	String KEY_CARINFO_USER = "user";
	String KEY_CARINFO_PASSWORD = "password";
	String KEY_CARINFO_ESN = "esn";
	String KEY_CARINFO_MDN = "mdn";
	String KEY_CARINFO_SKEY = "SKey";
