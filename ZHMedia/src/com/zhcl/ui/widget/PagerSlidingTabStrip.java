...
//		TypedArray a = context.obtainStyledAttributes(attrs, ATTRS);
		TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.PagerSlidingTabStrip/*ATTRS*/);
		tabTextSize = a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_tabTextSize, android.R.attr.textSize);
		tabTextColor = a.getColor(R.styleable.PagerSlidingTabStrip_tabTextColor, android.R.attr.textColor);
		L.e(tag, "tabTextSize=" + tabTextSize);
