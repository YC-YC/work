...
public class RecordPlayStateInfo implements Serializable {
	...
	public boolean equals(Object o) {
		...
		do{	
			if(songInfo == null && o2.getSongInfo() != null || songInfo != null && o2.getSongInfo() == null){
				isSame = false;
				L.i(tag, "null ~null");
				break;
			}
			if(songInfo != null && o2.getSongInfo() != null && !songInfo.getFileName().equals(o2.getSongInfo().getFileName())){
				isSame = false;
				L.i(tag, "~path");
				break;
			}
...
//				L.i(tag, "~currentPlayTime");
	...
	public String toString() {
		if(songInfo == null){
			return "isPlay :" + isPlay + " playMode: " + playMode + " currentPlayTime:" + currentPlayTime;
		}
		return "isPlay :" + isPlay + " playMode: " + playMode + " currentPlayTime:" + currentPlayTime + " songInfo : " + songInfo.toString();
	}
