...
/**
 * @author YC
 * @time 2016-12-9 下午4:32:15
 * TODO:
 */
public class OtherInfo extends FileInfo {

	public OtherInfo(String path, String name, long modifiled, long size) {
		super(path, name, modifiled, size);
	}

	public static String getDBTableName() {
		return Config.OTHER_DB_TABLE;
	}
	...
	public static OtherInfo getOtherInfoFromDBCursor(Cursor cursor){
		...
		return new OtherInfo(path, name, modifiled, size);
	}
}
